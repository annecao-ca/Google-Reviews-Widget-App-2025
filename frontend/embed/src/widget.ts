      ...
      <div class="gwr-widget gwr-theme-${settings.theme} gwr-layout-${settings.layout} gwr-style-${settings.cardStyle}" 
          ...
          <header class="gwr-header">
            <div class="gwr-header-main">
              ...
              <div class="gwr-header-info">
                <a href="${backendUrl}/api/redirect/google-reviews?placeId=${widget.placeId}&business=${encodeURIComponent(widget.businessName || '')}" target="_blank" style="text-decoration: none; color: inherit;">
                  <h3>${widget.title}</h3>
                </a>
            ...
            <a href="${backendUrl}/api/redirect/google-reviews?placeId=${widget.placeId}&business=${encodeURIComponent(widget.businessName || '')}" target="_blank" class="gwr-write-btn">
              Write a review
            </a>
          </header>
        ` : ""}
        ...
        <div class="gwr-reviews-container">
          ${summary.reviews.map(review => {
            ...
            return `
            <a href="${reviewLink}" target="_blank" class="gwr-review-card" style="text-decoration: none; color: inherit; display: block;">
